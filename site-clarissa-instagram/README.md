...
- `assets/bebe-cenario-infantil.jpg`
...
- `assets/marca-clarissa.jpg`
- `assets/fotografa-clarissa.jpg`

Não há imagens de banco, imagens geradas ou imagens da referência no pacote. A foto da fotógrafa aparece exclusivamente na seção “Sobre”.
